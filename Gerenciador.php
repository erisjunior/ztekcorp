...
<div class="container">
	...
	<div class="form-group">
		<form method="post" class="form-group" style="float: right; margin-top: -75px; margin-right: 60px;">
			...
			<input type="submit" class="form-group btn btn-primary" value="Home">

			<input type="submit" class="form-group btn btn-primary" value="Cadastro de Produtos">
...
<div class="row" style="height: 0px">
		...
		<div id="busca">
			...
			<div class="col-sm-6" style="float: right; margin-top: -49px; margin-right: -70px;">
...
while($dados = mysqli_fetch_assoc($query)){
		...
		echo "</td>";
		echo "<td>
		<a class='btn btn-warning glyphicon glyphicon-edit' href='atualizaProdutos.php?prod_id=".$dados['id']."'> Editar</a>
